...
| 盲角色输入隔离 | deny 名单逐名封死 `read`/`novel_*` | **封不住** → 降级为「只读派工包」**纪律条款**，盲读证据力低于 DSH 形态 |
...
- **收正（2026-09-21 · A1）**：人格段里的一类**能力否定句**已改为**义务否定句**，共 9 处（3 角色 × 3 落点：WB 侧 `agents/author.md`、`references/roles/reader.md`、`references/roles/calibrator.md`，另加两份 DSH 预设 `preset-starter/` 与 `preset-writer/` 各 3 处）。
